  ...
  return (
    <div className="banner-container">
      <div className="banner">
        <div className="banner-text w-75 mx-auto row ">
          <div className="col-md-8 mt-5 pt-5">
            ...
            <p className="w-75">
              Visiting healthcare centers are quite time consuming, thus, we are
              here to support you with all your healthcare needs under one roof.
              Book an appointment today for your check-ups, or just pass by at
              our drop-in champers,{" "}
            </p>{" "}
